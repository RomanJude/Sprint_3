...
public class DeleteCourierWithoutIdTest {
    ...
    @Test @DisplayName("Check deleting the courier without id")
    public void deleteCourierWithoutId() {
        ...
        String json3 = "{\"id\": " + id + "}";
        Response deleteCourierResponse = courierClient.deleteCourier(json3, "");
        deleteCourierResponse.then().assertThat().body("message", equalTo("Недостаточно данных для удаления курьера"))//Текст предупреждения не соответствует спецификации
                .and()
                .statusCode(400);
    }
